...
public final class KVGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = io.etcd.jetcd.api.RangeRequest.class,
      responseType = io.etcd.jetcd.api.RangeResponse.class,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = io.etcd.jetcd.api.PutRequest.class,
      responseType = io.etcd.jetcd.api.PutResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = io.etcd.jetcd.api.DeleteRangeRequest.class,
      responseType = io.etcd.jetcd.api.DeleteRangeResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = io.etcd.jetcd.api.TxnRequest.class,
      responseType = io.etcd.jetcd.api.TxnResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = io.etcd.jetcd.api.CompactionRequest.class,
      responseType = io.etcd.jetcd.api.CompactionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
